...
//{face: 1, direction: 0, row: 0 column: 0}
//steps in the 0 direction.
function step(object) {
    let dir = [[0, 1], [1, 0], [0, -1], [-1, 0]];

    object.row += dir[object.facing][0]
    object.column += dir[object.facing][1]
...
function getPosition(face, orientation, row, column, field) {
    //We 1-index cos easier
    let positions = [[], [50, 0], [100, 0],
    [50, 50],
    [0, 100], [50, 100],
    [0, 50]];
